...
//!
//! Owns the window, renderer, terminal, and input state. Methods for
//! hot-reloading config/themes live in a separate `reload` impl block.
...
use seance_config::{Config, MacosOptionAsAlt};
...
pub(crate) fn option_as_alt_from_config(cfg: MacosOptionAsAlt) -> OptionAsAlt {
    match cfg {
